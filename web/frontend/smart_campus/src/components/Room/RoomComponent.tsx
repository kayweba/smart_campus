            ...
            <>
                <Card className={styles.card_style}>
                    <CardContent sx={{padding: '12px'}}>
                        ...
                        <Box>
                            <Button size='small' variant='contained' sx={{marginTop: '12px', fontSize: '11px'}}
                                    onClick={() => handleClick()}>Подробнее</Button>
                        </Box>
                    </CardContent>
                </Card>
                <ModalWindow roomName={name} modalOpen={this.state.modalOpen} onClose={handleClose}
